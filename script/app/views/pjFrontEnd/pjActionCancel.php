			...
			<table class="table" cellspacing="2" cellpadding="5" style="width: 100%">
				...
				<tbody>	
					...
					<tr>
						...
						<td><?php echo date($tpl['option_arr']['o_date_format'], strtotime($tpl['arr']['start_dt'])) . ', ' . date($tpl['option_arr']['o_time_format'], strtotime($tpl['arr']['start_dt'])); ?></td>
					</tr>
					<tr>
						<td><?php __('front_services'); ?></td>
						<td><?php echo $tpl['services']; ?></td>
					</tr>
					<tr>
